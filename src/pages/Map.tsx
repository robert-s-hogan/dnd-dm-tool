...
//   - Phase 2 bridge: Supabase Realtime broadcasts map state to players
//
// Data shape lives in src/types/index.ts under GameMap / MapEntity (commented out).
// Store actions for map will mirror the character/session pattern in useStore.ts.
      ...
      <div className="bg-stone-800 border border-stone-700 rounded-xl p-6 text-left max-w-md mx-auto">
        ...
        <ul className="space-y-2 text-sm text-stone-400">
          {[
            ...
            'Phase 2 bridge: Supabase Realtime map events',
          ].map((item) => (
